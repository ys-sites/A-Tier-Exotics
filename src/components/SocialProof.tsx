...
export function SocialProof() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-1/3 h-1/2 bg-brand-accent/5 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-1/4 h-1/2 bg-brand-gray/50 blur-[150px] rounded-full pointer-events-none" />
