        ...
        <div className="flex justify-center md:justify-end">
          ...
          >
            ...
            <span className="text-[10px] text-gray-400 group-hover:text-gray-300 transition-colors duration-300 font-light leading-none">
              Made by <span className="inline-block ml-1 font-semibold text-white group-hover:text-brand-accent transition-colors duration-300">Noor AI</span> <span className="text-white/10 mx-1">|</span> AI Consultant Agency
            </span>
          </a>
        </div>
      </div>
